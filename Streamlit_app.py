...
col3.metric(label="Number of Negative Scores", value=v_negative_score_count, delta=-int(v_negative_score_count))
col4.metric(label="Number of Positive Scores", value=v_positive_score_count, delta=int(v_positive_score_count))
