...
col3.metric(label="Number of Negative Scores", value=-v_negative_score_count, delta_color="normal", help="Number of School districts with negative scores relative to the mean 4th grade score")
col4.metric(label="Number of Positive Scores", value=v_positive_score_count, delta_color="normal", help="Number of School districts with positive scores relative to the mean 4th grade score")
