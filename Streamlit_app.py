...
col3.metric(label="Number of Negative Scores", value=v_negative_score_count, delta=-"{0:.0%}".format(v_negative_score_percentage), help="Number of School districts with negative scores relative to the mean 4th grade score")
