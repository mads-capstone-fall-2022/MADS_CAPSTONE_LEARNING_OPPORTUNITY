...
child_oppurtunity_df = child_oppurtunity_df[child_oppurtunity_df['year'].isin(v_year_choice)]
...
fig = px.scatter_mapbox(data_frame=child_oppurtunity_index_data_df,lat='latitude', lon='longitude',color_continuous_scale = 'rdylgn', color='Segment',color_discrete_sequence=px.colors.qualitative.G10, size='cs_mn_all_abs' ,text='sedaleaname')#, hover_name='subject')
